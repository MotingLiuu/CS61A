...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1< goal:
        ...
        player, message = say(score0, score1, player)
        if message != None:
            print(message)
        turns += 1
    # END PROBLEM 5
...
def announce_lead_changes(score0, score1, last_leader=None):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    leader, lead_score, message = None, 0, None
    if score0 > score1:
        leader, lead_score = 0, score0 - score1
    elif score1 > score0:
        leader, lead_score = 1, score1 - score0
    
    if leader != None:
        if last_leader == None or last_leader != leader:
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    num_rolls, max_roll, max_score, score = 1, 1, 0, 0
...
def hog_pile_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if  opponent_score % 10 != 0 and (hefty_hogs(score, opponent_score) + score) % 10 == opponent_score % 10:
        return 0
    if hefty_hogs(score, opponent_score) >= threshold:
        return 0
