...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while distance < self.lower_bound and currPlace.is_hive == False:
            currPlace = currPlace.entrance
            distance += 1
        while len(currPlace.bees) == 0 and currPlace.is_hive == False:
            currPlace = currPlace.entrance
            distance += 1
            
        if currPlace.is_hive == True or distance > self.upper_bound:
            return None 
        else:
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        if self.health <= 0:
            ref_damage += self.damage
        for bee in currPlace.bees[:]:
            bee.reduce_health(ref_damage)
        # END Problem 5
...
class HungryAnt(Ant):
    ...
    def eat(self):
        ...
        if bee:
            ...
            self.cooldown = HungryAnt.chew_cooldown + 1
