class Transaction:
    ...
    def report(self):
        ...
        if self.changed():
            "*** YOUR CODE HERE ***"
            return str(self.id) + ': ' + ('increased ' if self.after > self.before else 'decreased ') + f'{self.before}->{self.after}'
...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        after = self.balance
        cur_transaction = Transaction(len(self.transactions), before, after)
